...
costs_1 = [-13.5, -15.0, -13.1, -17.2, -24.1, -29.3]
costs_2 = [-20.8, -28.4, -31.9, -41.9, -51.9, -63.1]
...
ax3.legend(loc='right center', bbox_to_anchor=(0.5, 1.2), ncol=2, borderaxespad=0.0, frameon=False)
#ax3.set_title('Costs')
